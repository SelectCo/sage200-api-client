...
class SopOrderLine
{
	public function __construct(
		...
		#[Assert\Type('bool')]
		public ?bool $is_to_split_line = null,
		...
		#[Assert\Type('float')]
		public ?float $to_allocate_quantity = null,
		...
		#[Assert\Type('bool')]
		public ?bool $mark_as_preferred = null,
		#[Assert\Type('float')]
		...
		#[Assert\Type('bool')]
		public ?bool $has_pop_order = null,
		#[Assert\Type('string'), Assert\Length(max: 20)]
		public ?string $back_to_back_status = null,
		#[Assert\Type('bool')]
