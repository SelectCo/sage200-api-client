...
class SopOrderLine
{
	public function __construct(
		...
		#[Assert\Type('bool')]
		public bool|null                       $is_to_split_line = null,
		...
		#[Assert\Type('float')]
		public float|null                      $to_allocate_quantity = null,
		...
		#[Assert\Type('bool')]
		public bool|null                       $mark_as_preferred = null,
		#[Assert\Type('float')]
		...
		#[Assert\Type('bool')]
		public bool|null                       $has_pop_order = null,
		#[Assert\Type('string'), Assert\Length(max: 20)]
		public string|null                     $back_to_back_status = null,
		#[Assert\Type('bool')]
		...
		#[Assert\Type('object')]
		public object|null                     $sop_order = null,
		#[Assert\Type('object')]
