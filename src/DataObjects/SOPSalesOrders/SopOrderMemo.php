...
/**
 * Memos are sections of text that can be used to make comments about a sales order.<br/><br/>Multiple
 * memos can be added to each sales order. The user that created the memo, the date it was created and
