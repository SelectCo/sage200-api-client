...
class SopOrder
{
	public function __construct(
		...
		#[Assert\Type('bool')]
		public ?bool $override_on_hold = null,
		#[Assert\Type('bool')]
		...
		#[Assert\Type('bool')]
		public ?bool $suppress_warnings = null,
		...
		#[Assert\Type('bool')]
		public ?bool $invoice_payment_with_order_immediately = null,
		#[Assert\Type('float')]
		...
		#[Assert\Type('float')]
		public ?float $payment_declared = null,
		#[Assert\Type('float')]
		public ?float $payment_undeclared = null,
		#[Assert\Type('float')]
		public ?float $declared_payment_remaining = null,
		...
		#[Assert\Type('object')]
		public ?object $payment_method = null,
		#[Assert\Type('object')]
		public ?object $payment_status = null,
