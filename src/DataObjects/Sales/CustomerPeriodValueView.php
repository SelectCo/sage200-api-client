...
class CustomerPeriodValueView
{
	public function __construct(
		...
		#[Assert\Type('string'), Assert\Length(max: 60)]
		public string|null $customer_analysis_code_1 = null,
		#[Assert\Type('string'), Assert\Length(max: 60)]
		public string|null $customer_analysis_code_2 = null,
		#[Assert\Type('string'), Assert\Length(max: 60)]
		public string|null $customer_analysis_code_3 = null,
		#[Assert\Type('string'), Assert\Length(max: 60)]
		public string|null $customer_analysis_code_4 = null,
		#[Assert\Type('string'), Assert\Length(max: 60)]
		public string|null $customer_analysis_code_5 = null,
		#[Assert\Type('int'), Assert\Length('64')]
		public int|null    $customer_period_value_id = null,
		#[Assert\Type('float')]
		...
		#[Assert\Type('int'), Assert\Length('64')]
		public int|null    $customer_analysis_period_id = null,
		#[Assert\Type('string'), Assert\Length(max: 20)]
