...
class NominalCodeView
{
	public function __construct(
		...
		public string|null $report_category_code = null,
		#[Assert\Type('string'), Assert\Length(max: 60)]
		public string|null $report_category_description = null,
		#[Assert\Type('int'), Assert\Length('64')]
		public int|null    $report_category_report_type_id = null,
		#[Assert\Type('int'), Assert\Length('64')]
		public int|null    $sofa_category_id = null,
		#[Assert\Type('string'), Assert\Length(max: 4)]
		public string|null $sofa_category_code = null,
		#[Assert\Type('string'), Assert\Length(max: 60)]
		public string|null $sofa_category_description = null,
		#[Assert\Type('int'), Assert\Length('64')]
		public int|null    $sofa_category_report_type_id = null,
		#[Assert\Type('int'), Assert\Length('64')]
		public int|null    $year_value_budget_type_id = null,
		#[Assert\Type('float')]
		public float|null  $year_value_budget_value = null,
		#[Assert\Type('float')]
		public float|null  $year_value_original_budget_value = null,
		#[Assert\Type('string'), Assert\Length(max: 50)]
		public string|null $report_category_budget_name = null,
		#[Assert\Type('bool')]
		...
		#[Assert\Type('float')]
		public float|null  $consolidated_adjustment = null,
		#[Assert\Type('bool')]
		public bool|null   $display_balances_in_selection_list = null,
		#[Assert\Type('float')]
		public float|null  $balance_year_to_date = null,
		#[Assert\Type('float')]
		public float|null  $debit_year_to_date = null,
		#[Assert\Type('float')]
		public float|null  $credit_year_to_date = null,
		#[Assert\Type('float')]
