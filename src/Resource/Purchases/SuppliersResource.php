...
class SuppliersResource
{
	 ...
	 * @return Response
	 */
	public function getSuppliers(?SageODataBuilder $queryParameters = null): Response
	{
	 ...
	 * @return Response
	 */
	public function getSupplier(float|int $id, ?SageODataBuilder $queryParameters = null): Response
	{
