...
class StocktakesResource
{
	 ...
	 * @return Response
	 */
	public function getStocktakes(SageODataBuilder|null $queryParameters = null): Response
	{
	 ...
	 * @return Response
	 */
	public function getStocktake(float|int $id, SageODataBuilder|null $queryParameters = null): Response
	{
