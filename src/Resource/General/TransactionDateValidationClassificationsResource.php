...
use Selectco\SageApi\Requests\General\TransactionDateValidationClassifications\GetTransactionDateValidationClassifications;

class TransactionDateValidationClassificationsResource
{
	/**
