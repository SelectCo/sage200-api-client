...
class NominalCodesResource
{
	 ...
	 * @return Response
	 */
	public function getNominalCodes(?SageODataBuilder $queryParameters = null): Response
	{
	 ...
	 * @return Response
	 */
	public function getNominalCode(float|int $id, ?SageODataBuilder $queryParameters = null): Response
	{
