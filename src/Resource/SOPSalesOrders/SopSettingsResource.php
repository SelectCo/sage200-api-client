...
use Selectco\SageApi\Requests\SOPSalesOrders\SopSettings\GetSopsetting;
use Selectco\SageApi\Requests\SOPSalesOrders\SopSettings\GetSopsettings;

class SopSettingsResource
{
	/**
	...
	/**
	 * @param float|int $id Unique Id of the SOP settings.
	 * @param SageODataBuilder|null $queryParameters
	 * @throws ODataInvalidArgumentException
	 * @throws FatalRequestException
	 * @throws RequestException
