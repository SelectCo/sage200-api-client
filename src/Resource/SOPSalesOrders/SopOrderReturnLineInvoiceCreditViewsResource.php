...
use Selectco\SageApi\Requests\SOPSalesOrders\SopOrderReturnLineInvoiceCreditViews\GetSoporderReturnLineInvoiceViews;

class SopOrderReturnLineInvoiceCreditViewsResource
{
	/**
