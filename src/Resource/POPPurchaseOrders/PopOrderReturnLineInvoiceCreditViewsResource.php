...
use Selectco\SageApi\Requests\POPPurchaseOrders\PopOrderReturnLineInvoiceCreditViews\GetPoporderReturnLineInvoiceViews;

class PopOrderReturnLineInvoiceCreditViewsResource
{
	/**
