...
use Selectco\SageApi\Requests\POPPurchaseOrders\PopOrderReturnLineReceiptReturnViews\GetPoporderReturnLineReceiptReturnViews;

class PopOrderReturnLineReceiptReturnViewsResource
{
	/**
