...
namespace Selectco\SageApi\Requests\Stock\SerialAllocatedToWhoTypes;
 ...
 */
class GetSerialAllocatedToWhoTypes extends Request
{
	...
	{
		$this->endPoint = "/serial_allocated_to_who_types";
		$this->queryString = '';
