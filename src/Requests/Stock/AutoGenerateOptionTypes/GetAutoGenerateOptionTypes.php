...
namespace Selectco\SageApi\Requests\Stock\AutoGenerateOptionTypes;
 ...
 */
class GetAutoGenerateOptionTypes extends Request
{
	...
	{
		$this->endPoint = "/auto_generate_option_types";
		$this->queryString = '';
