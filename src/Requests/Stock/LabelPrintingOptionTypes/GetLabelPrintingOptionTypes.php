...
namespace Selectco\SageApi\Requests\Stock\LabelPrintingOptionTypes;
 ...
 */
class GetLabelPrintingOptionTypes extends Request
{
	...
	{
		$this->endPoint = "/label_printing_option_types";
		$this->queryString = '';
