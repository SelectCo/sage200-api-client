...
namespace Selectco\SageApi\Requests\Stock\CostingMethodTypes;
 ...
 */
class GetCostingMethodTypes extends Request
{
	...
	{
		$this->endPoint = "/costing_method_types";
		$this->queryString = '';
