...
namespace Selectco\SageApi\Requests\Stock\ProductPurchaseFigures;
 ...
 * (analysis_code_n).</P>
 */
class GetProductPurchaseFigures extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/product_purchase_figures/{$this->id}";
		$this->queryString = '';
