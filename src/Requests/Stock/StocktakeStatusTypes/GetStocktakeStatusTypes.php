...
namespace Selectco\SageApi\Requests\Stock\StocktakeStatusTypes;
 ...
 */
class GetStocktakeStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/stocktake_status_types";
		$this->queryString = '';
