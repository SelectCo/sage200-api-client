...
namespace Selectco\SageApi\Requests\Stock\ProductSearchTypes;
...
class GetProductSearchTypes extends Request
{
	...
	{
		$this->endPoint = "/product_search_types";
		$this->queryString = '';
