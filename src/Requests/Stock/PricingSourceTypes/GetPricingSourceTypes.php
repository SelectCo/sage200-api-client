...
namespace Selectco\SageApi\Requests\Stock\PricingSourceTypes;
 ...
 */
class GetPricingSourceTypes extends Request
{
	...
	{
		$this->endPoint = "/pricing_source_types";
		$this->queryString = '';
