...
namespace Selectco\SageApi\Requests\Stock\ProductTransactionViews;
 ...
 */
class GetProductTransactionViews extends Request
{
	...
	{
		$this->endPoint = "/product_transaction_views";
		$this->queryString = '';
