...
namespace Selectco\SageApi\Requests\Stock\ProductTransactionTypes;
 ...
 */
class GetProductTransactionTypes extends Request
{
	...
	{
		$this->endPoint = "/product_transaction_types";
		$this->queryString = '';
