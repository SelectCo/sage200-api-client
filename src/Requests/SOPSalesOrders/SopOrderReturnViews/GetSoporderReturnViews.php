...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopOrderReturnViews;
 ...
 */
class GetSoporderReturnViews extends Request
{
	...
	{
		$this->endPoint = "/sop_order_return_views";
		$this->queryString = '';
