...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopTradeLineStatusTypes;
 ...
 */
class GetSoptradeLineStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/sop_trade_line_status_types";
		$this->queryString = '';
