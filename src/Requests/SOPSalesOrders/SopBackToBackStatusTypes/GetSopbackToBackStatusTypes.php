...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopBackToBackStatusTypes;
 ...
 */
class GetSopbackToBackStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/sop_back_to_back_status_types";
		$this->queryString = '';
