...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopOrderDespatchViews;
 ...
 * descending.
 */
class GetSoporderDespatchViews extends Request
{
	...
	{
		$this->endPoint = "/sop_order_despatch_views";
		$this->queryString = '';
