...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopShowOnPickingListTypes;
 ...
 */
class GetSopshowOnPickingListTypes extends Request
{
	...
	{
		$this->endPoint = "/sop_show_on_picking_list_types";
		$this->queryString = '';
