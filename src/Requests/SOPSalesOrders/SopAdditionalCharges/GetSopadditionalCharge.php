...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopAdditionalCharges;
 ...
 */
class GetSopadditionalCharge extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/sop_additional_charges/{$this->id}";
		$this->queryString = '';
