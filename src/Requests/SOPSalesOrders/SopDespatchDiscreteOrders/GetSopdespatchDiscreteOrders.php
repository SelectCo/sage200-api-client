...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopDespatchDiscreteOrders;
 ...
 * document_date.
 */
class GetSopdespatchDiscreteOrders extends Request
{
	...
	{
		$this->endPoint = "/sop_despatch_discrete_orders";
		$this->queryString = '';
