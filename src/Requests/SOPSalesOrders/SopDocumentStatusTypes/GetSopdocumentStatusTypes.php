...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopDocumentStatusTypes;
 ...
 */
class GetSopdocumentStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/sop_document_status_types";
		$this->queryString = '';
