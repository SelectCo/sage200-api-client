...
namespace Selectco\SageApi\Requests\SOPSalesOrders\SopInvoiceCreditTypes;
 ...
 */
class GetSopinvoiceCreditTypes extends Request
{
	...
	{
		$this->endPoint = "/sop_invoice_credit_types";
		$this->queryString = '';
