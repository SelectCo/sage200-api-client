...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopIntrastatStatusTypes;
 ...
 */
class GetPopintrastatStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/pop_intrastat_status_types";
		$this->queryString = '';
