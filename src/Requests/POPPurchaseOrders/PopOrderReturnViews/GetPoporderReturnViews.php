...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopOrderReturnViews;
 ...
 */
class GetPoporderReturnViews extends Request
{
	...
	{
		$this->endPoint = "/pop_order_return_views";
		$this->queryString = '';
