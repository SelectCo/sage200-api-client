...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopOrderGenerationTypes;
 ...
 */
class GetPoporderGenerationTypes extends Request
{
	...
	{
		$this->endPoint = "/pop_order_generation_types";
		$this->queryString = '';
