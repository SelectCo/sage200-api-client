...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopDocumentStatusTypes;
 ...
 */
class GetPopdocumentStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/pop_document_status_types";
		$this->queryString = '';
