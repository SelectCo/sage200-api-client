...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopInvoiceCreditTypes;
 ...
 */
class GetPopinvoiceCreditTypes extends Request
{
	...
	{
		$this->endPoint = "/pop_invoice_credit_types";
		$this->queryString = '';
