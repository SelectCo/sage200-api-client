...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopTradeLineStatusTypes;
 ...
 */
class GetPoptradeLineStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/pop_trade_line_status_types";
		$this->queryString = '';
