...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopAuthorisationStatusTypes;
...
/**
 * GetPOPAuthorisationStatusTypes
 *
 ...
 */
class GetPopauthorisationStatusTypes extends Request
{
	...
	{
		$this->endPoint = "/pop_authorisation_status_types";
		$this->queryString = '';
