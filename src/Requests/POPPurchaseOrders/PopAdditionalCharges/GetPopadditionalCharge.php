...
namespace Selectco\SageApi\Requests\POPPurchaseOrders\PopAdditionalCharges;
 ...
 * what each additional charges is for.
 */
class GetPopadditionalCharge extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/pop_additional_charges/{$this->id}";
		$this->queryString = '';
