...
namespace Selectco\SageApi\Requests\General\AccountingPeriodValidationTypes;
...
/**
 * GetAccountingPeriodValidationTypes
 *
 ...
 */
class GetAccountingPeriodValidationTypes extends Request
{
	...
	{
		$this->endPoint = "/accounting_period_validation_types";
		$this->queryString = '';
