...
namespace Selectco\SageApi\Requests\Commercials\IntrastatDateTypes;
 ...
 */
class GetIntrastatDateTypes extends Request
{
	...
	{
		$this->endPoint = "/intrastat_date_types";
		$this->queryString = '';
