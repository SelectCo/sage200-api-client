...
/**
 * DeleteSupplierFaxForSupplierAndSupplierContact
 *
 ...
 * fields.
 */
class DeleteSupplierFaxForSupplierAndSupplierContact extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/suppliers/{$this->supplierId}/supplier_contacts/{$this->supplierContactId}/supplier_faxes/{$this->id}";
	}
