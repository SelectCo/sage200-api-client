...
/**
 * GetMemosForPurchasePostedTransaction
 *
 ...
 * deleting them.
 */
class GetMemosForPurchasePostedTransaction extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/purchase_posted_transactions/{$this->transactionId}/purchase_posted_transaction_memos";
		$this->queryString = '';
