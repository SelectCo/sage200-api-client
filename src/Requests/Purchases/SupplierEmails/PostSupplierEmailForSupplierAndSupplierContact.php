...
/**
 * PostSupplierEmailForSupplierAndSupplierContact
 *
 ...
 * contact fields.
 */
class PostSupplierEmailForSupplierAndSupplierContact extends Request implements HasBody
{
	use HasJsonBody;
	...
	public function __construct(
		...
		$this->endPoint = "/suppliers/{$this->supplierId}/supplier_contacts/{$this->supplierContactId}/supplier_emails";
	}
