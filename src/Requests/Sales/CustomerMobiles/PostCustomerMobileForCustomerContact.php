...
/**
 * PostCustomerMobileForCustomerContact
 *
 ...
 * fields.
 */
class PostCustomerMobileForCustomerContact extends Request implements HasBody
{
	use HasJsonBody;
	...
	public function __construct(
		...
		$this->endPoint = "/customer_contacts/{$this->customerContactId}/customer_mobiles";
	}
