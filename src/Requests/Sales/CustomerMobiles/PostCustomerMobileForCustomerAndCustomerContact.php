...
/**
 * PostCustomerMobileForCustomerAndCustomerContact
 *
 ...
 * fields.
 */
class PostCustomerMobileForCustomerAndCustomerContact extends Request implements HasBody
{
	use HasJsonBody;
	...
	public function __construct(
		...
		$this->endPoint = "/customers/{$this->customerId}/customer_contacts/{$this->customerContactId}/customer_mobiles";
	}
