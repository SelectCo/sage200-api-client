...
/**
 * DeleteCustomerMobileForCustomerContact
 *
 ...
 * fields.
 */
class DeleteCustomerMobileForCustomerContact extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/customer_contacts/{$this->customerContactId}/customer_mobiles/{$this->id}";
	}
