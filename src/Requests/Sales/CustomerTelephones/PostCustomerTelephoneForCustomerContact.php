...
/**
 * PostCustomerTelephoneForCustomerContact
 *
 ...
 * contact fields.
 */
class PostCustomerTelephoneForCustomerContact extends Request implements HasBody
{
	use HasJsonBody;
	...
	public function __construct(
		...
		$this->endPoint = "/customer_contacts/{$this->customerContactId}/customer_telephones";
	}
