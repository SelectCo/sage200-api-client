...
/**
 * DeleteCustomerFaxForCustomerAndCustomerContact
 *
 * Delete a customer fax for customer and customer contact.
 */
class DeleteCustomerFaxForCustomerAndCustomerContact extends Request
{
