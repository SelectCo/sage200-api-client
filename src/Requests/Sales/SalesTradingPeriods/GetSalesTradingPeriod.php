...
namespace Selectco\SageApi\Requests\Sales\SalesTradingPeriods;
 ...
 * periods).
 */
class GetSalesTradingPeriod extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/sales_trading_periods/{$this->id}";
		$this->queryString = '';
