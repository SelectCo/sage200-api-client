...
namespace Selectco\SageApi\Requests\Sales\StatementLayoutTypes;
 ...
 */
class GetStatementLayoutTypes extends Request
{
	...
	{
		$this->endPoint = "/statement_layout_types";
		$this->queryString = '';
