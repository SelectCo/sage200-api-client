...
namespace Selectco\SageApi\Requests\Sales\StatementAgeingTerms;
...
class GetStatementAgeingTerms extends Request
{
	...
	{
		$this->endPoint = "/statement_ageing_terms";
		$this->queryString = '';
