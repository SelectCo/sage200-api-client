...
namespace Selectco\SageApi\Requests\Sales\CustomerPeriodValueViews;
 ...
 * The default sort (orderby) field are by 'customer_reference', 'customer_analysis_period_id',
 * 'customer_period_value_id' ascending.
 */
class GetCustomerPeriodValueViews extends Request
{
	...
	{
		$this->endPoint = "/customer_period_value_views";
		$this->queryString = '';
