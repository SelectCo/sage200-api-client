...
namespace Selectco\SageApi\Requests\Sales\DocumentTransmissionMethodTypes;
...
/**
 * GetDocumentTransmissionMethodTypes
 *
 ...
 */
class GetDocumentTransmissionMethodTypes extends Request
{
	...
	{
		$this->endPoint = "/document_transmission_method_types";
		$this->queryString = '';
