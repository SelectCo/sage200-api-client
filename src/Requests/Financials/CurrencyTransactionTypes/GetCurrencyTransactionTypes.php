...
namespace Selectco\SageApi\Requests\Financials\CurrencyTransactionTypes;
 ...
 */
class GetCurrencyTransactionTypes extends Request
{
	...
	{
		$this->endPoint = "/currency_transaction_types";
		$this->queryString = '';
