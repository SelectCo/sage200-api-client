...
namespace Selectco\SageApi\Requests\Financials\FinancialReportRowLineTypes;
...
/**
 * GetFinancialReportRowLineTypes
 *
 ...
 * used.
 */
class GetFinancialReportRowLineTypes extends Request
{
	...
	{
		$this->endPoint = "/financial_report_row_line_types";
		$this->queryString = '';
