...
namespace Selectco\SageApi\Requests\Financials\AgedBalancesAgeingTypes;
 ...
 */
class GetAgedBalancesAgeingTypes extends Request
{
	...
	{
		$this->endPoint = "/aged_balances_ageing_types";
		$this->queryString = '';
