...
namespace Selectco\SageApi\Requests\Financials\TraderPaymentTerms;
 ...
 */
class GetTraderPaymentTerms extends Request
{
	...
	{
		$this->endPoint = "/trader_payment_terms";
		$this->queryString = '';
