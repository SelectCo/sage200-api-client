...
namespace Selectco\SageApi\Requests\Financials\TraderLocationTypes;
 ...
 */
class GetTraderLocationTypes extends Request
{
	...
	{
		$this->endPoint = "/trader_location_types";
		$this->queryString = '';
