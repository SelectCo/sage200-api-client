...
namespace Selectco\SageApi\Requests\PriceBook\CustomerDiscountGroups;
 ...
 * individually.
 */
class GetCustomerDiscountGroup extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/customer_discount_groups/{$this->id}";
		$this->queryString = '';
