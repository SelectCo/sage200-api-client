...
namespace Selectco\SageApi\Requests\Nominal\NominalAccountTypes;
 ...
 */
class GetNominalAccountTypes extends Request
{
	...
	{
		$this->endPoint = "/nominal_account_types";
		$this->queryString = '';
