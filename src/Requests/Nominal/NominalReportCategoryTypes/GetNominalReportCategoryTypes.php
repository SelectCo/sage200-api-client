...
namespace Selectco\SageApi\Requests\Nominal\NominalReportCategoryTypes;
 ...
 */
class GetNominalReportCategoryTypes extends Request
{
	...
	{
		$this->endPoint = "/nominal_report_category_types";
		$this->queryString = '';
