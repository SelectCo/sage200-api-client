...
namespace Selectco\SageApi\Requests\Nominal\ConsolidatedNominalCodes;
 ...
 */
class GetConsolidatedNominalCode extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/consolidated_nominal_codes/{$this->id}";
		$this->queryString = '';
