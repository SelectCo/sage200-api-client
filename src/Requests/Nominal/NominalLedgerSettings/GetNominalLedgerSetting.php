...
namespace Selectco\SageApi\Requests\Nominal\NominalLedgerSettings;
 ...
 */
class GetNominalLedgerSetting extends Request
{
	...
	public function __construct(
		...
		$this->endPoint = "/nominal_ledger_settings/{$this->id}";
		$this->queryString = '';
