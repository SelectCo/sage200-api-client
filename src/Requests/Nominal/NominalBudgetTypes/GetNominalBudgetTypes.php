...
namespace Selectco\SageApi\Requests\Nominal\NominalBudgetTypes;
 ...
 */
class GetNominalBudgetTypes extends Request
{
	...
	{
		$this->endPoint = "/nominal_budget_types";
		$this->queryString = '';
