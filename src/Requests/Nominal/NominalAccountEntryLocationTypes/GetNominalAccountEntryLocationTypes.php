...
namespace Selectco\SageApi\Requests\Nominal\NominalAccountEntryLocationTypes;
...
/**
 * GetNominalAccountEntryLocationTypes
 *
 ...
 */
class GetNominalAccountEntryLocationTypes extends Request
{
	...
	{
		$this->endPoint = "/nominal_account_entry_location_types";
		$this->queryString = '';
