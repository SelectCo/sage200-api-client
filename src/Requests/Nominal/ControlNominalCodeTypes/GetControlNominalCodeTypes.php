...
namespace Selectco\SageApi\Requests\Nominal\ControlNominalCodeTypes;
 ...
 * that can be used.
 */
class GetControlNominalCodeTypes extends Request
{
	...
	{
		$this->endPoint = "/control_nominal_code_types";
		$this->queryString = '';
